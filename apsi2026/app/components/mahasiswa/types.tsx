// app/components/mahasiswa/types.ts

export type TabType = 'dashboard' | 'cpl' | 'riwayat';
export type CplSubTab = 'grafik' | 'lk' | 'report';
export type SortBy = 'semester' | 'nama' | 'nilai' | 'huruf';
...
export const detailCPL: DetailCplItem[] = [
  {
    ...
    ik: [
      {
        kode: 'IK-1.1', deskripsi: 'Memahami konsep dasar matematika teknik', bobot: 50, nilai: 87,
        cpmk: [
          { kode: 'CPMK-1.1', deskripsi: 'Mahasiswa mampu menjelaskan konsep probabilitas',     bobot: 40, nilai: 85, matakuliah: 'Statistika Industri (TI2101)', semester: 3, nilaiMK: 'A' },
          { kode: 'CPMK-1.2', deskripsi: 'Mahasiswa mampu menghitung distribusi probabilitas',  bobot: 60, nilai: 88, matakuliah: 'Statistika Industri (TI2101)', semester: 3, nilaiMK: 'A' },
        ],
      },
      {
        kode: 'IK-1.2', deskripsi: 'Menerapkan metode statistika dalam analisis data', bobot: 50, nilai: 83,
        cpmk: [
          { kode: 'CPMK-2.1', deskripsi: 'Mahasiswa mampu melakukan uji hipotesis', bobot: 100, nilai: 83, matakuliah: 'Statistika Industri (TI2101)', semester: 3, nilaiMK: 'A' },
        ],
      },
    ],
  },
  {
    ...
    ik: [
      {
        kode: 'IK-2.1', deskripsi: 'Merancang sistem produksi yang efisien', bobot: 100, nilai: 78,
        cpmk: [
          { kode: 'CPMK-3.1', deskripsi: 'Mahasiswa mampu merancang tata letak pabrik',   bobot: 50, nilai: 75, matakuliah: 'Perancangan Tata Letak Pabrik (TI2102)', semester: 4, nilaiMK: 'B+' },
          { kode: 'CPMK-3.2', deskripsi: 'Mahasiswa mampu menganalisis aliran material',  bobot: 50, nilai: 80, matakuliah: 'Perancangan Tata Letak Pabrik (TI2102)', semester: 4, nilaiMK: 'B+' },
        ],
      },
    ],
  },
  {
    ...
    ik: [
      {
        kode: 'IK-7.1', deskripsi: 'Berkomunikasi lisan dan tertulis dengan efektif', bobot: 100, nilai: 0,
        cpmk: [
          { kode: 'CPMK-7.1', deskripsi: 'Mahasiswa mampu mempresentasikan hasil kerja', bobot: 100, nilai: 0, matakuliah: 'Kerja Praktek (TI3501)', semester: 7, nilaiMK: '-' },
        ],
      },
    ],
  },
...
export const riwayatNilaiData: RiwayatItem[] = [
